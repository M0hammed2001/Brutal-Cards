...
namespace BrutalCards
{
    ...
    public class CardAnimator : MonoBehaviour
    {
        ...
        public Card topCard;
        public float startingCardValue;
        ...
        void InitializeDeck()
        {
            ...
            float randomCard = UnityEngine.Random.Range(0, 51);
        ...
        public void MoveToDiscardPile(Card c){
            c.transform.position = startCardPosition;
            c.SetFaceUp(true);
        }
